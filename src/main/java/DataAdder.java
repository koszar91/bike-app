...
public class DataAdder {
    public static void add() {
        ...
        // users with bikes
        Bike b1 = new Bike(Bike.Color.Black, Bike.BikeType.ROAD);
        User u1 = new User("Bob", "Dylan", "bobby1", "01-02-1970", b1);
        Bike b2 = new Bike(Bike.Color.Yellow, Bike.BikeType.MOUNTAIN);
        User u2 = new User("Tom", "Ford", "tom90", "21-06-1995", b2);
        Bike b3 = new Bike(Bike.Color.Red, Bike.BikeType.ROAD);
        User u3 = new User("Lucas", "Smith", "luke9", "01-12-1999", b3);
        Bike b4 = new Bike(Bike.Color.Black, Bike.BikeType.ELECTRIC);
        User u4 = new User("Bruce", "Willis", "willywonka", "22-08-2000", b4);
        Bike b5 = new Bike(Bike.Color.White, Bike.BikeType.HYBRID);
        User u5 = new User("Dough", "West", "dest67", "17-11-2005", b5);


        // friends
        u1.getFriends().add(u2);u1.getFriends().add(u3);u1.getFriends().add(u4);u1.getFriends().add(u5);
        u2.getFriends().add(u1);u2.getFriends().add(u3);u2.getFriends().add(u4);u2.getFriends().add(u5);
        u3.getFriends().add(u1);u3.getFriends().add(u2);
        u4.getFriends().add(u1);u4.getFriends().add(u2);
        u5.getFriends().add(u1);u5.getFriends().add(u2);
